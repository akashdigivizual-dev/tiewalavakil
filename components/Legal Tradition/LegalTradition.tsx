...
const LegalTraditionSection = () => {
  return (
    <section className="legal-section">
      <div className="container">
        {/* ---- Section Heading ---- */}
        <div className="section-header">
          <h2>Generations of Legal Tradition</h2>
          <p>
            Our family has been in the legal service sector. Today, Advocate Ajay
            Shankar Sharma continues this legacy, combining traditional legal
            expertise with digital innovation to serve the entire region from
            Hapur.
          </p>
        </div>
        ...
        <div className="family-grid">
          ...
          <div className="member">
            ...
            <p className="legacy">Founder of Legal Heritage</p>
          </div>
          ...
          <div className="member">
            ...
            <p className="role">Family Legal Tradition</p>
          </div>
        ...
        <div className="highlight-box">
          ...
          <p>
            ...
            from Hapur, fulfilling all your property-related legal needs with the
...
export default LegalTraditionSection;
